...
export const mockPeople: Person[] = [
  {
    ...
    formacao: "Engenharia Civil - USP",
    status: "ativo",
    empresa: "EIXO Engenharia",
    contrato: "EIXO 1",
    contratosAtivos: ["EIXO 1", "CONTRATO GLOBAL"],
    email: "joao.silva@eixo.com.br",
    telefone: "(11) 98765-4321",
    areas: ["rodovia", "saneamento"],
    disciplina: "PROJETO",
    competencias: ["Projeto de Rodovia", "Obra de Saneamento"],
    disciplinasProjeto: ["DRENAGEM", "GEOMETRIA", "PAVIMENTAÇÃO", "TERRAPLANAGEM"],
    dataAdmissao: "2020-03-15",
    vigenciaInicio: "2020-03-15",
    vigenciaFim: "2024-03-15",
    termoConfidencialidade: true,
    apresentouCartaoCnpj: true,
    numeroCnpj: "12.345.678/0001-90",
    conselhoClasse: "CREA",
    anoRegistroConselho: 2009,
    numeroRegistroConselho: "123456/SP",
    certidaoQuitacaoPf: true,
    certidaoQuitacaoPj: true,
    curriculo: true,
    historicoProfissional: "10 anos de experiência em grandes obras de infraestrutura viária.",
    treinamentos: ["NR-10", "NR-35", "BIM Management"]
  },
  {
    id: 2,
    nome: "Maria Santos",
